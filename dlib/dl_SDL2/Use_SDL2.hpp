...
class Use_SDL2 : public GUI
{
public:

	// Use_SDL2(int size_h, int size_w, int *press_button);

	static Use_SDL2		*getInstance(int size_h, int size_w, int *press_button);
	~Use_SDL2();
...
// MARK: - Singlton patern => deleting the methods copy and oper=
	Use_SDL2(Use_SDL2 const & ref) = delete;
	Use_SDL2		&operator=(Use_SDL2 const & ref) = delete;
