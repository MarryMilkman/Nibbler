...
Use_SDL2		*Use_SDL2::getInstance(int size_h, int size_w, int *press_button) {
	static Use_SDL2		*instance = new Use_SDL2(size_h, size_w, press_button);
